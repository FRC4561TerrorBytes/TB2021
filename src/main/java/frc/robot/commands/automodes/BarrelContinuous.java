...
public class BarrelContinuous extends SequentialCommandGroup {
  /** Creates a new BarrelContinuous. */
  public BarrelContinuous(DriveSubsystem driveSubsystem) {
    ...
    super(
      ...
      // new AutoTrajectory(driveSubsystem, "output/BarrelThreePointFive.wpilib.json").getCommand()
    );
  }
}
